...
<head>
    ...
    <title>E-cash Pramuka SMK Negeri 2 Tangerang Selatan</title>
    <!-- Bootstrap Core CSS -->
...
<body>
    ...
    $(document).ready(function() {
        ...
        $.toast({
            heading: 'Selamat Datang di Kas Keuangan Pramuka SMK Negeri 2 Tangerang Selatan',
            text: 'Aplikasi pengeloala Kas Keuangan by Alv.',
            position: 'top-right',
            loaderBg: '#ff6849',
            icon: 'info',
            hideAfter: 3500,
